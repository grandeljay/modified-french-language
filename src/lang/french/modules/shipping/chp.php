...
define('MODULE_SHIPPING_CHP_TEXT_TITLE', 'Poste suisse');
define('MODULE_SHIPPING_CHP_TEXT_DESCRIPTION', 'Poste suisse');
define('MODULE_SHIPPING_CHP_TEXT_WAY', 'Expédition vers');
define('MODULE_SHIPPING_CHP_TEXT_UNITS', 'kg');
define('MODULE_SHIPPING_CHP_INVALID_ZONE', 'Désolé, l\'expédition vers ce pays n\'est pas possible.');
define('MODULE_SHIPPING_CHP_UNDEFINED_RATE', 'Les frais d\'expédition ne peuvent pas être calculés pour le moment.');

define('MODULE_SHIPPING_CHP_STATUS_TITLE', 'Poste suisse');
define('MODULE_SHIPPING_CHP_STATUS_DESC', 'Souhaitez-vous proposer la livraison par la Poste suisse ?');
define('MODULE_SHIPPING_CHP_HANDLING_TITLE', 'Frais de traitement');
define('MODULE_SHIPPING_CHP_HANDLING_DESC', 'Frais de manutention pour ce mode d\'expédition en CHF');
define('MODULE_SHIPPING_CHP_TAX_CLASS_TITLE', 'Type de taxe');
define('MODULE_SHIPPING_CHP_TAX_CLASS_DESC', 'Sélectionnez le taux de TVA pour cette méthode d\'expédition.');
define('MODULE_SHIPPING_CHP_ZONE_TITLE', 'Zone de répartition');
define('MODULE_SHIPPING_CHP_ZONE_DESC', 'Si vous sélectionnez une zone, ce mode d\'expédition n\'est proposé que dans cette zone.');
...
define('MODULE_SHIPPING_CHP_COST_PRI_2_TITLE', 'Tableau des tarifs pour la zone 1 jusqu\'à 30 kg PRI');
define('MODULE_SHIPPING_CHP_COST_PRI_2_DESC', 'Tableau des tarifs pour la zone 1, basé sur <b>PRI</b> jusqu\'à 30 kg de poids d\'expédition.');
...
define('MODULE_SHIPPING_CHP_COST_PRI_3_TITLE', 'Tableau des tarifs pour la zone 2 jusqu\'à 30 kg PRI');
define('MODULE_SHIPPING_CHP_COST_PRI_3_DESC', 'Tableau des tarifs pour la zone 2, basé sur <b>\'PRI</b> jusqu\'à 30 kg de poids d\'expédition.');
...
define('MODULE_SHIPPING_CHP_COST_PRI_4_TITLE', 'Tableau des tarifs pour la zone 3 jusqu\'à 30 kg PRI');
define('MODULE_SHIPPING_CHP_COST_PRI_4_DESC', 'Tableau des tarifs pour la zone 3, basé sur <b>\'PRI</b> jusqu\'à 30 kg de poids d\'expédition.');
...
define('MODULE_SHIPPING_CHP_COST_PRI_5_TITLE', 'Tableau des tarifs pour la zone 4 jusqu\'à 30 kg PRI');
define('MODULE_SHIPPING_CHP_COST_PRI_5_DESC', 'Tableau des tarifs pour la zone 4, basé sur <b>\'PRI</b> \'jusqu\'à 30 kg de poids d\'expédition.');
...
define('MODULE_SHIPPING_CHP_COST_PRI_6_TITLE', 'Tableau des tarifs pour la zone 4 jusqu\'à 30 kg PRI');
define('MODULE_SHIPPING_CHP_COST_PRI_6_DESC', 'Tableau des tarifs pour la zone 4, basé sur <b>\'PRI</b> \'jusqu\'à 30 kg de poids d\'expédition.');
...
define('MODULE_SHIPPING_CHP_COST_PRI_7_TITLE', 'Tableau des tarifs pour la zone 5 jusqu\'à 30 kg PRI');
define('MODULE_SHIPPING_CHP_COST_PRI_7_DESC', 'Grille tarifaire pour la zone 5, basée sur <b>"PRI</b> " jusqu\'à un poids d\'expédition de 30 kg.');
define('MODULE_SHIPPING_CHP_COST_URG_7_TITLE', 'Tableau des tarifs pour la zone 5 jusqu\'à 30 kg URG');
define('MODULE_SHIPPING_CHP_COST_URG_7_DESC', 'Grille tarifaire pour la zone 5, basée sur <b>\'URG\'</b> jusqu\'à 30 kg de poids d\'expédition.');
