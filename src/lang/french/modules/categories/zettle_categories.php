 ...
 */
  ...
  define('MODULE_CATEGORIES_ZETTLE_CATEGORIES_DESCRIPTION', 'Des systèmes de caisse modernes comme application pour l\'acceptation des paiements et le suivi des ventes : facilitez votre vie quotidienne avec Zettle.<br> <br>Les fonctions suivantes sont actuellement prises en charge : <ul style="padding-left: 20px;"> <li>Les articles sont transférés de la boutique à Zettle</li> <li>Possibilité de créer son propre groupe de clients pour les prix des articles</li> <li>Le stock est synchronisé entre la boutique et Zettle sur demande.</li> </ul>');
