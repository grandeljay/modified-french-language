...
define('MODULE_PAYMENT_MCP_SERVICE_ORDER_STATUS_PENDING_PAYMENT_FRENCH_TITLE', 'Paiement en suspens');
define('MODULE_PAYMENT_MCP_SERVICE_ORDER_STATUS_PARTPAY_FRENCH_TITLE', 'Je m\'abonne, paiement partiel');
define('MODULE_PAYMENT_MCP_SERVICE_ORDER_STATUS_PROCESSING_FRENCH_TITLE', 'en cours');
define('MODULE_PAYMENT_MCP_SERVICE_ORDER_STATUS_CANCELLED_FRENCH_TITLE', 'Annulé');
define('MODULE_PAYMENT_MCP_SERVICE_ORDER_STATUS_PAYMENT_REVIEW_FRENCH_TITLE', 'Ordre de contrôle');
define('MODULE_PAYMENT_MCP_SERVICE_ORDER_STATUS_CONFLICT_FRENCH_TITLE', 'Problème d\'événement !');
