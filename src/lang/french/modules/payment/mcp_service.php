...
define('MODULE_PAYMENT_MCP_SERVICE_STATUS_DESC', 'Mise en service des modules micropayment&trade;.');
...
define('MODULE_PAYMENT_MCP_SERVICE_ACCOUNT_ID_TITLE', '<div style="color:#850000;font-style: italic;">Les paramètres suivants sont valables pour tous les modules de paiement micropayment&trade; et ne doivent être saisis qu\'une seule fois.</div><br /> ID du compte');
...
define('MODULE_PAYMENT_MCP_SERVICE_PROJECT_CODE_DESC', 'Code du projet Micropayment&trade;.');
...
define('MODULE_PAYMENT_MCP_SERVICE_SECRET_FIELD_VALUE_DESC', 'Entrez ici une valeur que le serveur micropayment&trade; doit donner à votre boutique pour améliorer la sécurité.');
...
define('MODULE_PAYMENT_MCP_SERVICE_NEW_VERSION', 'Une<div class="mcp_notice_register">nouvelle version du module micropayment&trade; avec de nouvelles fonctions et caractéristiques pour votre système de boutique</div><div class="mcp_notice_register">est maintenant</div> disponible.<div class="mcp_notice_register"> <a href="http://ecommerce.micropayment.de/modifiedshop/" target="_new">Vers la nouvelle version du module.</a></div>');

define('MODULE_PAYMENT_MCP_SERVICE_NO_ACCOUNT', 'Pour que les modules de<div class="mcp_notice_register">paiement Micropayment&trade; fonctionnent, vous devez créer un compte Micropayment&trade; et créer un projet. <a href="https://%s.micropayment.de" target="blank">Cliquez ici pour vous inscrire.</a></div>');
define(
...
define('MODULE_PAYMENT_MCP_SERVICE_ORDER_STATUS_PENDING_PAYMENT_SPANISH_TITLE', 'Paiement en suspens');
define('MODULE_PAYMENT_MCP_SERVICE_ORDER_STATUS_PARTPAY_SPANISH_TITLE', 'Je m\'abonne, paiement partiel');
define('MODULE_PAYMENT_MCP_SERVICE_ORDER_STATUS_PROCESSING_SPANISH_TITLE', 'en cours');
define('MODULE_PAYMENT_MCP_SERVICE_ORDER_STATUS_CANCELLED_SPANISH_TITLE', 'Annulé');
define('MODULE_PAYMENT_MCP_SERVICE_ORDER_STATUS_PAYMENT_REVIEW_SPANISH_TITLE', 'Ordre de contrôle');
define('MODULE_PAYMENT_MCP_SERVICE_ORDER_STATUS_CONFLICT_SPANISH_TITLE', 'Problème d\'événement !');
