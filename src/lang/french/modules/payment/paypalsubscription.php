...
$lang_array = array(
    ...
    'MODULE_PAYMENT_PAYPALSUBSCRIPTION_TEXT_DESCRIPTION'          => 'PayPal comme lien de paiement qui n\'est disponible pour le client qu\'une fois la commande terminée. Vous décidez vous-même où le client reçoit la demande de paiement.',
    ...
    'MODULE_PAYMENT_PAYPALSUBSCRIPTION_TEXT_EXTENDED_DESCRIPTION' => '<strong><font color="red">ATTENTION :</font></strong> Effectuez les réglages sous "Modules partenaires" -&gt; "PayPal" -&gt; "PayPal" -&gt; "PayPal" -&gt; "PayPal" -&gt; "PayPal" -&gt; "PayPal" -&gt; "PayPal" -&gt; "PayPal" -&gt; "PayPal". <a href="' . xtc_href_link('paypal_config.php') . '"><strong>"Paramètres de PayPal".</strong></a> Faites-le !',
