...
define(
    ...
    (defined('MODULE_PAYMENT_EUSTANDARDTRANSFER_ACCNAM')  ? '<br />Code bancaire : ' . MODULE_PAYMENT_EUSTANDARDTRANSFER_ACCNAM : '') .
    (defined('MODULE_PAYMENT_EUSTANDARDTRANSFER_ACCNUM')  ? '<br />Numéro de compte : ' . MODULE_PAYMENT_EUSTANDARDTRANSFER_ACCNUM : '') .
    ...
    '<br />Utilisation prévue : %s' .
    '<br /><br />Les marchandises ne seront livrées que lorsque le montant aura été crédité sur notre compte.<br />'
);
...
if (defined('MODULE_PAYMENT_EUSTANDARDTRANSFER_SUCCESS') && 'True' === MODULE_PAYMENT_EUSTANDARDTRANSFER_SUCCESS) {
    ...
    define('MODULE_PAYMENT_EUSTANDARDTRANSFER_TEXT_INFO', 'Veuillez transférer le montant de la facture due sur notre compte. Vous recevrez les détails du compte par e-mail une fois que votre commande aura été acceptée.');
}
...
define('MODULE_PAYMENT_EUSTANDARDTRANSFER_ACCNAM_DESC', 'Le code bancaire du compte spécifié.');
