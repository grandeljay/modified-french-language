...
$lang_array = array(
  ...
  'MODULE_PAYMENT_PAYPALACDC_TEXT_EXTENDED_DESCRIPTION' => '<strong><font color="red">ATTENTION :</font></strong> Veuillez encore effectuer les réglages sous "Modules partenaires" -> "PayPal" -> <a href="'.xtc_href_link('paypal_config.php').'"><strong>"Configuration PayPal"</strong></a>!',
  ...
  'MODULE_PAYMENT_PAYPALACDC_TEXT_SAVE_PAYMENT' => 'Enregistrer le mode de paiement en toute sécurité. Vous pourrez ainsi payer plus rapidement, plus facilement et plus confortablement lors de votre prochain achat.',
  'MODULE_PAYMENT_PAYPALACDC_TEXT_OR' => 'ou',
);
