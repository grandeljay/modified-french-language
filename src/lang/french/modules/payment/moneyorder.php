...
if (defined('MODULE_PAYMENT_MONEYORDER_SUCCESS') && 'True' === MODULE_PAYMENT_MONEYORDER_SUCCESS) {
    define('MODULE_PAYMENT_MONEYORDER_TEXT_INFO', 'Nous expédions votre commande après réception du paiement. Vous recevrez les détails du compte lors de la dernière étape de la commande.');
} else {
