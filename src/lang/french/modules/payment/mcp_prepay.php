...
define('MODULE_PAYMENT_MCP_PREPAY_TEXT_DESCRIPTION', 'Micropaiement Vorkasse Modul <br /><br /> Liens<br /> <b>Outils</b><br /> <a target="_new" href="../callback/micropayment/cleanup.php"> <input type="button" value="Commander" /> </a> <br /><br /> <b>Externe</b><br /> <a href="http://ecommerce.micropayment.de/download/modified/micropayment_modified-shop_2.x.pdf?version=2.1.0"> <input type="button" value="Manuel" /> </a> <a target="_new" href="https://r120.micropayment.de"> <input type="button" value="Enregistrement des micropaiements" /> </a>');
define('MODULE_PAYMENT_MCP_PREPAY_TEXT_TITLE', 'micropago™ Paiement anticipé');
define('MODULE_PAYMENT_MCP_PREPAY_TEXT_TITLE_EXTERN', 'Paiement anticipé');
define('MODULE_PAYMENT_MCP_PREPAY_TEXT_INFO', '<div style="margin:10px; height:140px;"> <div style="float:right;"><img src="./images/micropayment/logo_small.png" width="150"/></div> <div style="float:left;font-family: Arial, Helvetica, sans-serif;"> <b>Le bon de paiement pré-rempli vous sera envoyé par e-mail.</b><br /> Pour compléter votre commande, nous allons maintenant vous rediriger vers le site web<br /> de notre fournisseur de services de paiement micropayment™.<br /><br /> ✔ sécurisé ✔ simple ✔ sans inscription </div> </div>');
