...
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_INVOICE_INFO1', 'Merci d\'avoir choisi de payer avec PayLater. Les montants dus seront débités du compte indiqué lors de votre commande. En plus de cette facture, vous recevrez sous peu un plan d\'échelonnement de BillPay avec des informations détaillées sur votre paiement échelonné.');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_INVOICE_INFO2', 'La demande a été faite par ');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_INVOICE_INFO3', '');

define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_FEE_INFO1', 'Les frais de PayLater pour cette commande sont de ');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_FEE_INFO2', '');
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_PROMO', 'Appuyez sur le bouton radio pour en afficher davantage.');

define('MODULE_PAYMENT_BILLPAY_OT_PAYLATER_FEE', 'Frais de service');
define('MODULE_PAYMENT_BILLPAY_OT_PAYLATER_TOTAL', 'Total PayLater');

define('MODULE_PAYMENT_BILLPAY_GIROPAY_CANCELED', 'Giropay annulé');

define('MODULE_PAYMENT_BILLPAYPAYLATER_VISUAL_MODE_TITLE', 'Mode visuel');
define('MODULE_PAYMENT_BILLPAYPAYLATER_VISUAL_MODE_DESC', '');

define('MODULE_PAYMENT_BILLPAYPAYLATER_THANK_YOU_TEXT', 'Merci d\'avoir choisi BillPay PayLater - Paiement partiel lors de l\'achat de marchandises.');
define('MODULE_PAYMENT_BILLPAYPAYLATER_PAY_UNTIL_TEXT', 'Les montants dus seront débités mensuellement du compte spécifié lors de la commande.');
define('MODULE_PAYMENT_BILLPAYPAYLATER_EMAIL_TEXT', 'En plus de la facture, vous recevrez sous peu un plan de paiement avec des informations détaillées sur vos versements.');
