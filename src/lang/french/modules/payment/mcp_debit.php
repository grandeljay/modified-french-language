...
define(
    ...
    'micropayment&trade; Direct Debit Module
    <br /><br />
    Liens<br />
    <b>Outils</b><br />
...
define(
    ...
    '<div style="margin:10px; height:140px;">
        ...
        <div style="float: left;">
           <b>Veuillez préparer les détails de votre compte.</b><br />
...
define('MODULE_PAYMENT_MCP_DEBIT_STATUS_DESC', 'Module de débit direct Micropayment&trade;.');
