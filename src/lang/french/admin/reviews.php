...
define('HEADING_TITLE', 'Commentaires sur les produits');

define('TABLE_HEADING_PRODUCTS', 'Article');
define('TABLE_HEADING_CUSTOMER', 'Cliente');
define('TABLE_HEADING_RATING', 'Évaluation');
...
define('ENTRY_REVIEW', 'Revue :');
define('ENTRY_REVIEW_TEXT', '<span class="smallText colorRed"><b>NOTE :</b></span> <span class="smallText">Le HTML ne se convertit pas ! </span>');
define('ENTRY_RATING', 'Valorisation :');

define('TEXT_INFO_DELETE_REVIEW_INTRO', 'Êtes-vous sûr de vouloir supprimer cette critique ?');
...
define('TEXT_INFO_HEADING_DELETE_REVIEW', 'Supprimer la révision');
