...
define('HEADING_TITLE', 'File d\'attente pour la libération des bons d\'achat');

define('TABLE_HEADING_CUSTOMERS', 'Clients');
define('TABLE_HEADING_ORDERS_ID', 'N° de commande');
define('TABLE_HEADING_VOUCHER_VALUE', 'Valeur du bon d\'achat');
...
define('TEXT_REDEEM_COUPON_SUBJECT', 'Acheter un bon d\'achat');
define('TEXT_INFO_DELETE_INTRO', 'Le bon d\'achat doit-il être supprimé ?');
define('TEXT_INFO_REDEEM_INTRO', 'Le bon d\'achat doit-il être utilisé ?');
